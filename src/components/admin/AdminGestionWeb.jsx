  ...
  const handleSave = async () => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        P3Archis: toISO(dates.P3Archis),
        Peks: toISO(dates.Peks)
      })
      .eq('id', dates.id)
      .single();
          ...
          <Collapse in={showShotgun}>
            <div>
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  <Form.Label>P3/Archis</Form.Label>
                  <Form.Control
                    type="datetime-local"
                    value={toDatetimeLocal(dates?.P3Archis)}
                    onChange={e => handleChange("P3Archis", e.target.value)}
                  />
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label>Pek's</Form.Label>
                  <Form.Control
                    type="datetime-local"
                    value={toDatetimeLocal(dates?.Peks)}
                    onChange={e => handleChange("Peks", e.target.value)}
                  />
                </Form.Group>
